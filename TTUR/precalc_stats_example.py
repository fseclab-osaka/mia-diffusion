...
# PATHS
########
data_path = '/home/t-matsumoto/fid/celeba_123456/images' # set path to training set images
output_path = '/home/t-matsumoto/fid/celeba_123456/fid_stats.npz' # path for where to store the statistics
